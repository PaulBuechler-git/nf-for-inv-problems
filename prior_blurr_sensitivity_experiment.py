...
def main(device, parsed_args):
    ...
    cursor.execute("CREATE TABLE prior_blurr_sensitivity_experiment(prior_val, std, img_index, start_time, end_time)")
    connection.commit()
...
if __name__ == "__main__":
    parser = ArgumentParser(description="Prior Blurr sensitivity experiment")
