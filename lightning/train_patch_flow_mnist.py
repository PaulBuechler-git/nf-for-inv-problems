...
from flow_models.PatchFlow import ClassPatchFlow
...
def main(prop_args):
    ...
    model = ClassPatchFlow(input_dims=img_dims, multiscale_blocks=multiscale_blocks, block_depth=block_depth, hidden_channels=hidden_channels)
