...
def Downsample(input_img, scale=0.25):
    ...
    gaussian_std = 2
    kernel_size = 16
    gaussian_down = utils.gaussian_downsample(kernel_size, gaussian_std, int(1 / scale),
                                              pad=True)  # gaussian downsample with zero padding
...
if __name__ == '__main__':
    ...
    utils.save_img(rec, 'results/patchNR_material_custom')
