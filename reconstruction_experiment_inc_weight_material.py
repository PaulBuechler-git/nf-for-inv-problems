...
def main(device, parsed_args):
    ...
    for lam in np.linspace(lam_start, lam_end, lam_steps):
        ...
        cursor.execute("INSERT INTO reconstruction_experiment_inc_noise_metrics VALUES(?, ?, ?, ?, ?)", (psnr, psnr_deg, mssim, mssim_deg, lam))
        connection.commit()
    connection.close()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--result_path", type=str, default="results/reconstruction_experiment_inc_weight")
